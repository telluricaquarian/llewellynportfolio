...
export function FeaturedProject() {
  const projects = [
    ...
    },
    {
      ...
      description: "Avantsavant is an intellectual and educational platform oriented toward keeping pace with software, AI, and structured learning. It is built for people who take their own development seriously.",
      sections: [
        {
          title: "The Premise",
          content: "The pace of change in software and AI makes deliberate, structured learning a competitive advantage. Avantsavant exists to make that learning organized, honest, and ongoing.",
        },
        {
