...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Llewellyn Fisher",
    images: [
      {
        url: "https://damilareoo.xyz/images/000.png",
        width: 1200,
        height: 630,
        alt: "Llewellyn Fisher - Designer and Product Builder",
        type: "image/png",
      },
    ],
    locale: "en_US",
  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      <head>
        ...
        <meta property="og:image:alt" content="Llewellyn Fisher - Designer and builder" />
        <meta property="og:image:type" content="image/png" />

        <meta name="twitter:image" content="https://damilareoo.xyz/images/000.png" />
        <meta name="twitter:image:alt" content="Llewellyn Fisher - Designer and builder" />
        <meta name="twitter:card" content="summary_large_image" />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://damilareoo.xyz" />
        <meta property="og:title" content="Llewellyn Fisher – Designer & Product Builder" />
        ...
        <meta property="og:site_name" content="Llewellyn Fisher" />

        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="Llewellyn" />
      </head>
